  ...
  return (
    <div className="h-full mt-5 flex flex-col justify-center items-center ">
      <div className="mb-3 mt-3 text-sm">
        <a
          href="https://www.instagram.com/cafetwentysix?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
          target="_blank"
        >
          <img src={instagram} alt="instagram" className="w-10 h-10 mb-5" />
        </a>
      </div>
      <button
