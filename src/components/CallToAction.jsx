    ...
    <>
      <section className="relative w-full h-[175px] md:h-[300px] ">
        ...
        <div className="absolute inset-0 flex justify-center items-center gap-6">
          <button className="rounded-lg px-11 py-1 text-center bg-gray-50 text-black text-sm cursor-pointer hover:bg-zinc-800 hover:text-white drop-shadow-sm hover:drop-shadow-md hover:scale-105 transition-all duration-400">
            <a href="tel:+447342888171" aria-label="Call Café Twenty Six"> Call </a>
          </button>
            <button className="rounded-lg px-7 py-1 text-center text-shadow-lg text-sm bg-green-700 text-white hover:bg-green-500 cursor-pointer drop-shadow-md hover:drop-shadow-lg hover:scale-105 transition-all duration-400 ">
              <a
